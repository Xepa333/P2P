    ...
    <AnimatedSection id="kpis">
        ...
        <div className="overflow-x-auto rounded-lg bg-gray-800/50 shadow-lg mb-12">
            <table className="w-full text-left">
                ...
                <tbody className="divide-y divide-gray-700">
                    <tr className="hover:bg-gray-700/30"><td className="p-4 text-xl font-medium">Reach</td><td className="p-4 text-lg text-gray-300">Unique HCPs reached, specialty mix, geographic spread</td></tr>
                    ...
                    <tr className="hover:bg-gray-700/30"><td className="p-4 text-xl font-medium">Action Signals</td><td className="p-4 text-lg text-gray-300">Click-through to brand site, MSL request, rep engagement</td></tr>
                </tbody>
            </table>
        </div>
         <div className="grid md:grid-cols-2 gap-12">
